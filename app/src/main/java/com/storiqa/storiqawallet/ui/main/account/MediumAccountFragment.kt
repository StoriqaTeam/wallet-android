...
class MediumAccountFragment : Fragment() {

    companion object {
        private const val KEY_ACCOUNT = "key_account"

        fun newInstance(account: Account): MediumAccountFragment {
            val bundle = Bundle()
            bundle.putParcelable(KEY_ACCOUNT, account)
            return MediumAccountFragment().also { it.arguments = bundle }
        }
    }

    private lateinit var binding: ItemAccountMediumBinding
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.item_account_medium, container, false)
