...
import static com.storiqa.cryptokeys.Util.ByteUtil.bigIntegerToBytes;
...
public class ECKey implements Serializable {
    ...
    public static class ECDSASignature {
        ...
        public String toHex() {
            ...
            final String hexR = ByteUtil.toZeroPaddedHexString(bigIntegerToBytes(this.r), 64);
            final String hexS = ByteUtil.toZeroPaddedHexString(bigIntegerToBytes(this.s), 64);
